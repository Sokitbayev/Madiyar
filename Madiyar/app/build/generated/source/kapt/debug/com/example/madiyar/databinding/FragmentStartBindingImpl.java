...
public class FragmentStartBindingImpl extends FragmentStartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_logo_temp, 1);
        sViewsWithIds.put(R.id.iv_logo, 2);
        sViewsWithIds.put(R.id.tv_slogan_big, 3);
        sViewsWithIds.put(R.id.tv_slogan_small, 4);
        sViewsWithIds.put(R.id.btn_enter, 5);
        sViewsWithIds.put(R.id.tv_not_registered, 6);
    }
    // views
    // variables
    // values
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.titleFragment == variableId) {
            setTitleFragment((com.example.madiyar.registrationandauth.StartFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setTitleFragment(@Nullable com.example.madiyar.registrationandauth.StartFragment TitleFragment) {
